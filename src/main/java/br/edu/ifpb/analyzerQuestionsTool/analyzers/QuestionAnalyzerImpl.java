...
import br.edu.ifpb.analyzerQuestionsTool.util.CoGrooUtils;
import br.edu.ifpb.analyzerQuestionsTool.util.LanguageToolUtils;
import br.edu.ifpb.analyzerQuestionsTool.util.StringTokenizerUtils;
import br.edu.ifpb.analyzerQuestionsTool.util.StringUtil;
import br.edu.ifpb.analyzerQuestionsTool.util.data.ReaderFile;
import br.edu.ifpb.analyzerQuestionsTool.util.data.WordsUtils;
import br.edu.ifpb.analyzerQuestionsTool.util.similarity.ScoreSimilarity;
...
public class QuestionAnalyzerImpl implements QuestionAnalyzer {
	...
	private void setClassesJava() {
		javaClasses = new ReaderFile().readerTxt();
	}
